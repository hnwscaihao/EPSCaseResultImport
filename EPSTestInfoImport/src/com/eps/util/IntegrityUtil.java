...
public class IntegrityUtil {
    ...
    private static final Logger logger = Logger.getLogger(IntegrityUtil.class.getName());
    ...
    public IntegrityUtil(String _hostname, int _port, String _user, String _password, int _apimajor, int _apiminor) {
        hostname = _hostname;
        port = _port;
        user = _user;
        password = _password;
...
//		createSession();
    ...
    public IntegrityUtil(String args[]) {
        hostname = args[0];
//		port = Integer.parseInt(args[1]);
    ...
    public void editissue(String id, Map<String, String> fieldValues) throws APIException {
        ...
        for (String fieldName : fieldValues.keySet()) {
            ...
            Option op = null;
            if (DealDataServiceImpl.RICH_FIELDS.contains(fieldName))
    ...
    public String createContent(String parentId, Map<String, String> fields, String type, String beforeId) throws APIException {
        ...
        for (Map.Entry<String, String> entry : fields.entrySet()) {
            ...
            Option op = null;
            if (DealDataServiceImpl.RICH_FIELDS.contains(entry.getKey()))
